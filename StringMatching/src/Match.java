...
public class Match {
    ...
    public double matchWithScore(String str1, String str2) {
        //get score factory
    ...
    public double matchWithAlign(String str1,  String str2) {
        ...
        swg.align();
        scores[0] = this.matchWithScore(str1, str2);

        //get an object of TextAlignerFactory
        TextAligner nw = alignFactory.getTextAligner("NW", str1, str2);
        nw.align();
        scores[1] = this.matchWithScore(str1, str2);

        //get an object of TextAlignerFactory
        TextAligner kmp = alignFactory.getTextAligner("KMP", str1, str2);
        kmp.align();
        scores[2] = this.matchWithScore(str1, str2);
    ...
    public void match() {
        for (int i = 0; i < paragraphsFromFirstText.size(); i++) {
            double score = matchWithAlign(paragraphsFromFirstText.get(i), paragraphsFromSecondText.get(i));
        }
    }
