...
public final class NeedlemanWunschGotoh implements TextAligner {
    ...
    public NeedlemanWunschGotoh(String firstText, String secondText) {
    ...
    public void align() {
        ...
        Alignment alignment =
                jaligner.NeedlemanWunschGotoh.align(firstSequence,
